...
<head>
  ...
  <title>Daftar Admin Kampus - Kampus Lapor</title>
      ...
      <form method="POST" action="{{ route('admin-register.store') }}" class="login-form" enctype="multipart/form-data">
        ...
        <div class="register-grid">
          <div class="form-group">
            ...
            <input id="nama" name="nama" type="text" value="{{ old('nama') }}" autocomplete="name" autofocus>
          ...
          <div class="form-group">
            ...
            <input id="kampus" name="kampus" type="text" value="{{ old('kampus') }}" placeholder="Contoh: Universitas Nusantara">
            @error('kampus') <p class="field-error">{{ $message }}</p> @enderror
          </div>

          <div class="form-group">
            <label for="kode_kampus">Kode Kampus/Domain</label>
            <input id="kode_kampus" name="kode_kampus" type="text" value="{{ old('kode_kampus') }}" placeholder="Contoh: UNUS / unus.ac.id">
            @error('kode_kampus') <p class="field-error">{{ $message }}</p> @enderror
          </div>

          <div class="form-group">
            <label for="unit">Unit/Bagian</label>
            <input id="unit" name="unit" type="text" value="{{ old('unit') }}" placeholder="Contoh: Sarpras, Kemahasiswaan">
            @error('unit') <p class="field-error">{{ $message }}</p> @enderror
          </div>

          <div class="form-group">
            <label for="alamat_kampus">Alamat Kampus</label>
            <input id="alamat_kampus" name="alamat_kampus" type="text" value="{{ old('alamat_kampus') }}">
